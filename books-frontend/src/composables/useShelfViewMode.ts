...
const storageKey = (shelf: ShelfRef) => `shelfViewMode:${shelf}`;

function readStored(shelf: ShelfRef): ViewMode | null {
 ...
 */
export function useShelfViewMode(shelf: ShelfRef, fallback: ViewMode = "list"): Ref<ViewMode> {
