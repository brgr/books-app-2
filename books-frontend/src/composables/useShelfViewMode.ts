...
const storageKey = (shelf: ReadingShelf) => `shelfViewMode:${shelf}`;

function readStored(shelf: ReadingShelf): ViewMode | null {
 ...
 */
export function useShelfViewMode(shelf: ReadingShelf, fallback: ViewMode = "list"): Ref<ViewMode> {
