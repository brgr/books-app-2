...
export function useClampToggle(elementRef: Ref<HTMLElement | null>, options: UseClampToggleOptions = {}) {
  ...
  function update() {
    ...
    maxHeight.value = expanded.value ? `${measureExpandedHeight(el)}px` : `${clampHeight}px`;
  }
